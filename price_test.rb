...
class PriceTest < Test::Unit::TestCase
  ...
  def test_price_calculation
    ...
    assert_equal(price_allowing_non_integer.calculatePrice(2), 5)
    assert_equal(price_allowing_non_integer.calculatePrice(2.5), 6.25)
    ...
    assert_equal(price_allowing_integer_only.calculatePrice(3), 15)
    assert_raises(RuntimeError,"This price can't be calculated for non integer quantities") {price_allowing_integer_only.calculatePrice(2.5)}
  end

  def test_price_calculation_with_offer
    # TODO
  end
end